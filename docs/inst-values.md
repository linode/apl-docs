---
slug: installation/values/
title: Default values.yaml for Otomi
---

The following example shows the minimal `values.yaml` to deploy Otomi (with all apps) on a Kubernetes cluster
