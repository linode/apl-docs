...
:::caution
This page describes the SOPS-based workflow for updating the admin password, which was removed in v6.0.0. See [Update the otomi-admin password](update-admin-password.md) for the current guide.
:::
